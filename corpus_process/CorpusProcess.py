...
from corpus_process.DocumentProcess import Document
from math import log10, sqrt
from db_process.interaction import Interaction
...
class Corpus(object):
    ...
    def evaluate_corpus_documents(self):
        ...
        """
        counter = 0
        for document_name in self.corpus_raw_document_list:
            Document(document_name).evaluate_term_frequency()
            counter += 1
            print(counter, end='\r')
        print(counter)
        ...
        for term_id in wi_dictionary_keys:
            ...
            for doc_id in huge_document_list:
                ...
                if key_tuple in wij_dictionary_keys:
                    ...
                    sum += wi * wi
            # as per equation
            si_dictionary[term_id] = sqrt(sum / N)
            counter += 1
            print(counter, end='\r')
        # invoking upload
